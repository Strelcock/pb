...
const file_bot_proto_rawDesc = "" +
	...
	"\fTrackService\x125\n" +
	"\bAddTrack\x12\x12.grpc.TrackRequest\x1a\x13.grpc.TrackResponse\"\x00B\x06Z\x04./pbb\x06proto3"
...
var file_bot_proto_goTypes = []any{
	...
	(*TrackResponse)(nil), // 6: grpc.TrackResponse
}
var file_bot_proto_depIdxs = []int32{
	...
	1, // 3: grpc.UserService.CreateUser:output_type -> grpc.UserResponse
	3, // 4: grpc.UserService.IsAdmin:output_type -> grpc.AdminResponse
	6, // 5: grpc.TrackService.AddTrack:output_type -> grpc.TrackResponse
